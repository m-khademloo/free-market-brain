...
namespace FreeMarket.ObjectExtending
{
    public static class FreeMarketDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the FreeMarketEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
