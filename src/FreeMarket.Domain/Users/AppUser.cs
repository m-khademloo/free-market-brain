...
namespace FreeMarket.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update FreeMarketDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update FreeMarketEfCoreEntityExtensionMappings to extend the IdentityUser entity
